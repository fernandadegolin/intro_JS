...
let voto = document.getElementById ('votacao');
    ...
    if (idade < 16){
        possoVotar.innerHTML = `Você tem ${idade} anos! <br> Não precisa votar.`;
        console.log(possoVotar)

    } else if (idade < 18 || idade > 65){
        possoVotar.innerHTML = `Você tem ${idade} anos! <br> Seu voto é opcional.`

    } else {
        possoVotar.innerHTML = `Você tem ${idade} anos! <br> Seu voto é obrigatorio.`;
    }
}
